...
assert.match(html, /id="customColorPreviewSwatch"/, 'custom color modal should use the same compact swatch control as the side panel');
assert.match(html, /id="customColorModalPalette"/, 'custom color modal should expose default swatches in the compact popover');
assert.match(html, /id="customColorModalCustomPalette"/, 'custom color modal should expose custom swatches in a separate compact row');
assert.match(html, /id="deleteCustomColorBtn"/, 'custom colors should be deletable from the compact popover');
assert.doesNotMatch(html, /id="customColorList"/, 'custom color modal should not use a separate management list');
assert.doesNotMatch(html, /저장된 커스텀 색상/, 'custom color modal should stay compact instead of showing a manager section');
...
assert.match(html, /function renderCustomColorModalPalette/, 'saved custom colors should render into the compact popover palette');
assert.match(html, /function selectCustomColorForEdit/, 'custom colors should support compact edit mode');
assert.match(html, /function deleteSelectedCustomColor/, 'custom colors should be removable from localStorage');
